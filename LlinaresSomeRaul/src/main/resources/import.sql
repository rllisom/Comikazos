...
INSERT INTO News (id, date_new, img_new, title, description) VALUES (1, '2025-05-12', 'https://i0.wp.com/www.tomosygrapas.com/wp-content/uploads/2025/05/Banner-Pacificador.jpg?resize=1024%2C576&ssl=1', 'Vuelve Pacificador con el primer tráiler de su segunda temporada', 'La plataforma de streaming Max lanza el primer avance del regreso de Pacificador con el teaser tráiler de la segunda temporada de su serie.');
INSERT INTO News (id, date_new, img_new, title, description) VALUES (2, '2025-05-06', 'https://i0.wp.com/www.tomosygrapas.com/wp-content/uploads/2025/05/Star-Wars-Banner.jpg?w=999&ssl=1', 'Star Wars se pasa al terror con una nueva serie', 'Dark Horse se prepara para darle un nuevo enfoque a Star Wars con una nueva serie de género de terror.');
INSERT INTO News (id, date_new, img_new, title, description) VALUES (3, '2025-05-05', 'https://i0.wp.com/www.tomosygrapas.com/wp-content/uploads/2025/05/predator-banner.jpg?w=1012&ssl=1', 'Predator se enfrenta a todo el Universo Marvel', 'Marvel Comics anuncia un nuevo crossover donde el icónico Predator de la franquicia cinematográfica, se enfrentará a todo el Universo Marvel.');